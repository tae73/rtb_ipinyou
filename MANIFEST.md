...
| **Neural anchor** (cautionary) — REAL iPinYou features + the REAL ESCM²-WC (Flax) | ESCM²-WC restores collapsed spread but overshoots level → **truthful** edge −47pp (over-bids); +23.5pp only under optimal shading | `witnesses/neural_anchor.json` | `witnesses/neural_anchor.py` | `witnesses/figures/fig_neural_anchor.png` |
