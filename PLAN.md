...
**Last Updated**: 2026-06-16 (Portfolio & 문서화 완료 — 영/한 layered README + technical_report + NUMBERS_LEDGER + hero figure 6 + 개념 SVG 6, 4-에이전트 적대검증 통과. Stage 8 결판: neural>LGB NOT robust(I²=0.82, 3427 단일집중), neural>LR robust)
